...
namespace TechTrendsProject.Models;

public partial class TechTrendsDatabaseContext : DbContext
{
    public TechTrendsDatabaseContext()
    {
    }

    public TechTrendsDatabaseContext(DbContextOptions<TechTrendsDatabaseContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Password=Kamo204123;Persist Security Info=False;User ID=Kamo44075359;Initial Catalog=TechTrendsDatabase;Data Source=nwuserver.database.windows.net");
